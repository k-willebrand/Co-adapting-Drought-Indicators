...
def make_model(contract_threshold_vals=-999999 * np.ones(num_DP), contract_action_vals=np.zeros(num_DP),
    ...
    datestr = ["2020-03-12", "2025-03-06", "2030-02-28", "2035-02-22", "2040-02-16", "2045-02-09", "2050-02-03",
               "2055-01-28", "2060-01-22", "2065-01-15", "2070-01-09", "2075-01-03", "2079-12-28", "2084-12-21",
               "2089-12-15", "2094-12-09", "2099-12-03"]
...
def Optimization():
    ...
    # Where to save seed and runtime files
    main_output_file_dir = 'outputs/testing_first_optimization_attempts_serial_SRI6_CMIP6_DS'  # Specify location of output files for different seeds
