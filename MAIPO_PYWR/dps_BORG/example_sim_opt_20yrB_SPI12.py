# Optimizes Danny's updated version of the model using CMIP6 scenarios for 2080-2100 only.
...
def Optimization():
    ...
    # Where to save seed and runtime files
    main_output_file_dir = 'outputs/SPI12_2080_2100_CMIP6_04Feb25'  # Specify location of output files for different seeds
