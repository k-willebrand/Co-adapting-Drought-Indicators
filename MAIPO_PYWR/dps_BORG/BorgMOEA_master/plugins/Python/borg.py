...
class Configuration:
    ...
    def initialize():
        ...
        # Fix: explictly set path to borg library (default approach did identify file)
        Configuration.setBorgLibrary(path='/Users/keaniw/Documents/Research/Chile Project/MAIPO_PYWR/dps_BORG/BorgMOEA_master/libborg.so')
        Configuration.seed()
    ...
    def startMPI():
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    # edit the line above to point to local libborgms.so file
                    Configuration.setBorgLibrary('/Users/keaniw/Documents/Research/Chile Project/MAIPO_PYWR/dps_BORG/BorgMOEA_master/libborgms.so')
                except OSError:
        ...
        # edit the line above to piont to the local libmpi.so equivalent
        #CDLL("/usr/local/Cellar/open-mpi/5.0.5/lib/openmpi/libompi_dbg_msgq.so", RTLD_GLOBAL)
        #CDLL("/Users/keaniw/Documents/Research/Chile Project/MAIPO_PYWR/dps_BORG/BorgMOEA_master/libompi_dbg_msgq.so")
        #CDLL("/usr/local/Cellar/open-mpi/5.0.5/lib/libmpi.dylib", RTLD_GLOBAL)
        #CDLL("/usr/local/Cellar/open-mpi/5.0.5/lib/libmpi.40.dylib", RTLD_GLOBAL)
        #CDLL("libmpi.dylib", RTLD_GLOBAL)
        #CDLL("libmpi.40.dylib", RTLD_GLOBAL)

        #CDLL("/usr/local/anaconda3/envs/MAIPO_PYWR_x86/lib/python3.9/site-packages/mpi4py/lib-pmpi/libmpe.dylib", RTLD_GLOBAL)  # installed via mpi4py
        # CDLL("/usr/local/anaconda3/envs/MAIPO_PYWR_x86/lib/python3.9/site-packages/mpi4py/MPI.cpython-39-darwin.so", RTLD_GLOBAL)  # installed via mpi4py
        CDLL('libmpi.dylib', RTLD_GLOBAL)
        #CDLL('/Users/keaniw/anaconda3/pkgs/mpich-3.3.2-he2630cc_1/lib/libmpi.12.dylib', RTLD_GLOBAL)
