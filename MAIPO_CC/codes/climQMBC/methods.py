...
(DQM), the Quantile Delta Mapping (QDM), the Unbiased Quantile Mapping (UQM_reference),
...
def UQM(obs,mod,var,frq='M'):
    """
    This function performs bias correction of modeled series based on observed
    data by the Unbiased Quantile Mapping (UQM_reference) method, as described by
