"""
Model builder for the Maipo Basin demo optimization.

This module exposes make_model(), which builds and returns a Pywr model
using demo data from:

Co-adapting-Drought-Indicators/demo/data_demo

It is intended to be imported by a smaller optimization/demo script.
"""
...
def make_model(contract_threshold_vals=-999999 * np.ones(num_DP), contract_action_vals=np.zeros(num_DP),
    ...
    df = {
        'url': f'{BASE_DATA_DIR}/{data_folder}/{indicator}.csv',  # 'data/SRI6.csv'
        "parse_dates": True,
        "index_col": "Timestamp",
        "dayfirst": True}
    DataFrameParameter(
    ...
    # flow_Yeso
    df = {
        'url': f'{BASE_DATA_DIR}/{data_folder}/YESO.csv',
        "parse_dates": True,
        "index_col": 0,
        "dayfirst": True}
    DataFrameParameter(
    ...
    # flow_Maipo
    df = {
        'url': f'{BASE_DATA_DIR}/{data_folder}/MAIPO.csv',
        "parse_dates": True,
        "index_col": 0,
        "dayfirst": True}
    DataFrameParameter(
    ...
    # flow_Colorado
    df = {
        'url': f'{BASE_DATA_DIR}/{data_folder}/COLORADO.csv',
        "parse_dates": True,
        "index_col": 0,
        "dayfirst": True}
    DataFrameParameter(
    ...
    # flow_Volcan
    df = {
        'url': f'{BASE_DATA_DIR}/{data_folder}/VOLCAN.csv',
        "parse_dates": True,
        "index_col": 0,
        "dayfirst": True}
    DataFrameParameter(
    ...
    # flow_Laguna Negra
    df = {
        'url': f'{BASE_DATA_DIR}/{data_folder}/LAGUNANEGRA.csv',
        "parse_dates": True,
        "index_col": 0,
        "dayfirst": True}
    DataFrameParameter(
    ...
    # flow_Maipo extra
    df = {
        'url': f'{BASE_DATA_DIR}/{data_folder}/MAIPOEXTRA.csv',
        "parse_dates": True,
        "index_col": 0,
        "dayfirst": True}
    DataFrameParameter(
    ...
    # aux_acueductoln
    df = {
        'url': f'{BASE_DATA_DIR}/{data_folder}/Extra data.csv',
        "parse_dates": True,
        "index_col": 0,
        "dayfirst": True,
